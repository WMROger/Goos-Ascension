...
public class BigRedBossAttackPointTrigger : MonoBehaviour
{
    ...
    private void Awake()
    {
        // Find BigRedBossAI in the parent's children
        ...
        if (enemyAI == null)
        {
            Debug.LogError("BigRedBossAI not found! Make sure this AttackPoint is a child of the enemy parent.");
        }
    }
